...
\caption{Confusion matrix for LogReg ($\eta{=}0.3$, 1000 iters) on the test set. Two key errors: \emph{Medium}$\to$\emph{Low} (29/107, frequent due to class imbalance) and \emph{High}$\to$\emph{Medium} (5/13, important as severe cases are downgraded).}
\label{fig:cm}
\end{figure}
