...
\begin{figure*}[t]
\centering
\includegraphics[width=0.92\textwidth]{figures/logreg_heatmap.png}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Regression:} Linear Regression significantly outperformed KNN (Test MSE 0.994 vs.\ 1.865), confirming a strong underlying linear relationship in the features. KNN remains weaker here because local averaging smooths predictions and cannot capture the same global linear trend as effectively.
...
\paragraph{Conclusion:} Linear Regression is the best regressor on this dataset (test MSE 0.994), while Logistic Regression is the best classifier (88.25\% accuracy, Macro-F1 0.819). Overall, the results indicate that global parametric models capture the structure of this dataset more effectively than local neighbor-based methods, especially under class imbalance.
