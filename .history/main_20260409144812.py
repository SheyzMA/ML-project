...
def main(args):
    ...
    if not args.test:
        ...
        # Shuffle once, then split all arrays with the same indices.
        indices = np.random.permutation(n_train)
        val_indices = indices[:n_val]
        train_indices = indices[n_val:]

        test_features = train_features[val_indices]
        test_labels_reg = train_labels_reg[val_indices]
        test_labels_classif = train_labels_classif[val_indices]
