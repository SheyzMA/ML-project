...
\caption{Confusion matrix for LogReg ($\eta{=}0.3$, 1000 iters) on the test set. The dominant error is \emph{Medium} misclassified as \emph{Low} (29/107); \emph{Medium} is never predicted as \emph{High}.}
\label{fig:cm}
\end{figure}
