...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Classification:} Logistic Regression is vastly superior to KNN (88.25\% accuracy, F1 0.819 vs.\ 0.590). From Figure~\ref{fig:cm}, two errors stand out: \emph{Medium}$\to$\emph{Low} (29/107, driven by class imbalance) and \emph{High}$\to$\emph{Medium} (5/13), where severe cases are missed --- their low recall ($8/13 \approx 62\%$) reduces Macro-F1, which is why it is reported alongside accuracy.
\end{itemize}
